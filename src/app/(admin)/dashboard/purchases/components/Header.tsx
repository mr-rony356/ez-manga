...
const UsersHeader = () => {
  ...
  return (
    <div className="flex flex-col gap-2 bg-background rounded p-5">
      <Input
        placeholder={'Search a log by custom ID, gateway ID, etc...'}
        defaultValue={query}
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              variant={'outline'}
              className={cn(
                'w-full lg:w-fit justify-start text-left font-normal text-foreground'
              )}
            >
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              variant={'outline'}
              className={cn(
                'w-full lg:w-[180px] justify-start text-left font-normal text-foreground'
              )}
            >
              <CalendarIcon className="mr-2 h-4 w-4" />
