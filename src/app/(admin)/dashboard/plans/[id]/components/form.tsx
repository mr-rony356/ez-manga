...
export default function PlanForm({ plan }: { plan: SubscriptionPlan }) {
  ...
  const form = useForm<z.infer<typeof planSchema>>({
    ...
    defaultValues: {
      ...
      series: plan.series.map(s => parseInt(s.id))
    }
  })
  ...
  async function onSubmit(data: z.infer<typeof planSchema>) {
    ...
    toast.promise(API.put(`/store/plans/${plan.id}`, data), {
        ...
        <div className="col-span-12 lg:col-span-3">
          <Card>
            ...
            <CardContent className='space-y-3'>
              ...
              <Button type='button' variant='destructive' className='w-full'>Delete plan</Button>
            </CardContent>
          </Card>
        </div>
          ...
          <Card>
            <FormField
              ...
              render={({ field }) => (
                <FormItem >
                  <FormControl>
                    <SeriesSelector defaultSeries={plan.series} onValueChange={onValueChange} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
